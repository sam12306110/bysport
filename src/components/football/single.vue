                ...
                <table frame="void" cellpadding="0" cellspacing="0" v-for="(item,key) in race" id="stf">
                  ...
                  <tr>
                    ...
                    <td align="right" style="width: 93px;">
                      ...
                      <a href="javascript:"
                         v-if="items.Match_Ho!=null&&items.Match_Ho!='0'"><font>{{items.Match_Ho}}</font></a>
                    </td>
                    <td align="right" style="width: 93px;">
                      <span class="qiu"
                            v-if="items.Match_DxDpl!=null&&items.Match_DxDpl!='0'">{{items.Match_DxGG1}}</span>
                      <a href="javascript:" title="大"
                         v-if="items.Match_DxDpl!=null&&items.Match_DxDpl!='0'"><font>{{items.Match_DxDpl}}</font></a>
                    </td>
                    <td style="width: 49px;" align="right">
                      ...
                      <a href="javascript:" title="单"
                         v-if="items.Match_DsDpl!=null&&items.Match_DsDpl!='0'"><font>{{items.Match_DsDpl}}</font></a>
                    </td>
                    <td style="width: 36px;" align="right" class="b_1st">
                      <a href="javascript:"
                         v-if="items.Match_Bmdy!=null&&items.Match_Bmdy!='0'"><font>{{items.Match_Bmdy}}</font></a>
                    </td>
                    <td style="width: 91px;" align="right" class="b_1st">
                      ...
                      <a href="javascript:"
                         v-if="items.Match_BHo!=null&&items.Match_BHo!='0'"><font>{{items.Match_BHo}}</font></a>
                    </td>
                    <td style="width: 88px;" align="right" class="b_1st">
                      <span class="qiu"
                            v-if="items.Match_Bdpl!=null&&items.Match_Bdpl!='0'">{{items.Match_Bdxpk1}}</span>
                      <a href="javascript:" title="大"
                         v-if="items.Match_Bdpl!=null&&items.Match_Bdpl!='0'"><font>{{items.Match_Bdpl}}</font></a>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                    ...
                    <td align="right">
                      ...
                      <a href="javascript:"
                         v-if="items.Match_Ao!=null&&items.Match_Ao!='0'"><font>{{items.Match_Ao}}</font></a>
                    </td>
                    <td align="right">
                      <span class="qiu"
                            v-if="items.Match_DxXpl!=null&&items.Match_DxXpl!='0'">{{items.Match_DxGG2}}</span>
                      <a href="javascript:" title="小"
                         v-if="items.Match_DxXpl!=null&&items.Match_DxXpl!='0'"><font>{{items.Match_DxXpl}}</font></a>
                    </td>
                    <td align="right">
                      <span class="qiu" v-if="items.Match_DsDpl!=null&&items.Match_DsDpl!='0'">双</span>
                      <a href="javascript:" title="双"
                         v-if="items.Match_DsSpl!=null&&items.Match_DsSpl!='0'"><font>{{items.Match_DsSpl}}</font></a>
                    </td>
                    <td align="right" class="b_1st">
                      <a href="javascript:"
                         v-if="items.Match_Bgdy1!=null&&items.Match_Bgdy1!='0'"><font>{{items.Match_Bgdy1}}</font></a>
                    </td>
                    <td align="right" class="b_1st">
                      <span class="qiu"
                            v-if="items.Match_BAo!=null&&items.Match_BAo!='0'">{{items.Match_ShowType == 'C' && items.Match_Ao != '0' ? items.Match_RGG : ''}}</span>
                      <a href="javascript:"
                         v-if="items.Match_BAo!=null&&items.Match_BAo!='0'"><font>{{items.Match_BAo}}</font></a>
                    </td>
                    <td align="right" class="b_1st">
                      <span class="qiu"
                            v-if="items.Match_Bdpl!=null&&items.Match_Bdpl!='0'">{{items.Match_Bdxpk2}}</span>
                      <a href="javascript:" title="小"
                         v-if="items.Match_Bdpl!=null&&items.Match_Bdpl!='0'"><font>{{items.Match_Bxpl}}</font></a>
                    </td>
                  </tr>
                  <tr>
                    <td align="left">和局</td>
                    <td align="right">
                      <a href="javascript:" title="和局"
                         v-if="items.Match_BzH!=null&&items.Match_BzH!='0'"><font>{{items.Match_BzH}}</font></a>
                    </td>
                    <td colspan="3"></td>
                    <td align="right" class="b_1st">
                      <a href="javascript:" title="和局"
                         v-if="items.Match_Bhdy1!=null&&items.Match_Bhdy1!='0'"><font>{{items.Match_Bhdy1}}</font></a>
                    </td>
